        ...
        <div className="mt-auto pt-4">
          <div className="flex items-center justify-between gap-2 border-t border-charcoal-950/8 pt-4">
            ...
            {/* <Link
              ...
              className="inline-flex items-center gap-1.5 rounded-full bg-charcoal-950 px-4 py-2 text-xs font-semibold text-cream-50 transition-all duration-200 hover:bg-copper-600 hover:-translate-y-0.5 hover:shadow-md"
            >
